%Plot a heat-map gif for the evolution of a phase space plot, made from
%multiple electron probe species

clear all
close all

%Last sdf file to be created, and time to be simulated until
lastSDF = 450;
maxTime = 50e-15;
xMax = -3e-6;
xMax = 13e-6;

%Create gif made from evolution plots
figure(1);
axis tight manual;
...
for i = 0:lastSdf
    ...
    xData = saved.dist_fn.x_px.Probe1.grid.x;
    yData = saved.dist_fn.x_px.Probe2.grid.y;
